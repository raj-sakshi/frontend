...
public class BookController {
	...
	public String addBookPage(Model model) {
		...
		ResponseEntity<List<Authors>> responseEntity = restTemplate.exchange("http://localhost:8888/author", HttpMethod.GET, null, new ParameterizedTypeReference<List<Authors>>() {});
	...
	public String editBookPage(@RequestParam("code") int code, Model model) {
		...
		ResponseEntity<List<Authors>> reEntity = restTemplate.exchange("http://localhost:8888/author", HttpMethod.GET, null, new ParameterizedTypeReference<List<Authors>>() {});
